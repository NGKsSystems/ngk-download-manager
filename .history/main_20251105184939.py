...
class DownloadManagerGUI:
    ...
    def _handle_hf_download(self, url, destination):
        ...
        # Parse HF URL and get repository info
            ...
            try:
                ...
                if repo_info_raw:
                    ...
                    if repo_info:
                        ...
                        self.root.after(0, lambda: messagebox.showerror("Error", "Could not get repository information"))
                else:
                    self.root.after(0, progress_dialog.close)
                    self.root.after(0, lambda: messagebox.showerror("Error", "Invalid Hugging Face URL"))
    ...
    def _youtube_download_worker(self, download_id, url, destination, options):
        ...
        try:
            ...
            if options.get('format_id'):
                success = self.youtube_downloader.download_with_format(
